...
router.post('/', (0, celebrate_1.celebrate)({ body: validate_1.CreateProject }), controller.createProject);
...
router.post('/:id/images', (0, celebrate_1.celebrate)({ body: validate_1.AddImageToProjectSchema }), controller.addImages);
router.put('/:id/assign/admin', (0, celebrate_1.celebrate)({ body: validate_1.AssignAdminsToProjectSchema }), ac_1.default.check({
    resource: 'admin',
    action: 'read',
...
router.get('/:id/download', ac_1.default.check({
